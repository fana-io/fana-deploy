...
class FanaApp extends cdk.App {
  constructor() {
    ...
    const shared = new SharedResources(this, "fana-shared-resources");
    
    console.log(`Resources created in ${shared.vpc}`);
    console.log(`Created: ${shared.redis}`);
    console.log(`Created: ${shared.postgres}`);
